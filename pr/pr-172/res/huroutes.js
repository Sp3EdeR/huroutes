...
{const cfg=huroutes.opt.map.curvatureData;$.when($.ajax(cfg.geojson),$.ajax(cfg.style)).done((r1,r2)=>{const styleMap=r2[0];lg.addLayer(L.geoJson(r1[0],{attribution:cfg.attribution,style:(feature)=>feature.properties.styleUrl&&styleMap[feature.properties.styleUrl]}));});}}
