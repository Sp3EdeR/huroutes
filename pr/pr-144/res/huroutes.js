...
{var eNav=$('\
<div class="btn-group mr-2" role="group" title="{0}">\
  <a href="#" class="nav-start btn btn-primary" title="{1}"><i class="fas fa-step-backward"></i></a>\
  <a href="#" class="btn btn-primary btn-wide disabled"><i class="fas fa-route"></i></a>\
  <a href="#" class="nav-end btn btn-primary" title="{2}"><i class="fas fa-step-forward"></i></a>\
</div>'.format(langDict.navTooltip,langDict.navStartTooltip,langDict.navEndTooltip));eNav.find('.nav-start').click(()=>planTo(start));eNav.find('.nav-end').click(()=>planTo(end));elem.append(eNav);}
...
</div>'.format(langDict.dlRouteTooltip));eDownload.find('.download').click(()=>dlRoute.download(coords,routeId)??false);elem.append(eDownload);}
...
</div>'.format(langDict.streetViewTooltip));eNav.find('.strt-vw').click(()=>streetViewAt(coord,coordNext));elem.append(eNav);}
