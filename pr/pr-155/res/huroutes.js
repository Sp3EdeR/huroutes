...
tileOverlay.addTo(map);map.createPane('bkgRoutes');map.getPane('bkgRoutes').style.zIndex=450;$.getJSON('data.json',initializeContent).fail(()=>{err=()=>console.error('Failed loading the route database.');if(0<$('head base[href]').length)
$.getJSON('huroutes/data.json',initializeContent).fail(err);else
