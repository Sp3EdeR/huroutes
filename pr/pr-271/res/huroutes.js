...
if(id=='Full Send')
{const cfg=huroutes.opt.map.fullSendData;getJSON(cfg.geojson).done(r1=>{lg.addLayer(L.geoJson(r1[0],{attribution:cfg.attribution,interactive:false}));});}}
