    ...
    'opt': {
        ...
        'map': {
            ...
            'tiles': {
                ...
                'Sattelite': L.tileLayer.provider('Esri.WorldImagery',{className: 'tile-sattelite'}),
                ...
                'Google Sattelite': L.tileLayer('https://{s}.google.com/vt/lyrs=s,h&x={x}&y={y}&z={z}',{attribution:'&copy; Google Maps',minZoom:5,maxZoom:18,subdomains:['mt0', 'mt1', 'mt2', 'mt3'],className: 'tile-googlesattelite'})
            },
